...
@Repository("sjdao")
public class _01_15_08_SungJuk_DAO implements _01_15_08_SungJuk_InterDAO {

    // 넘겨받은 성적데이터를 sungjuk테이블에 저장
    @Override
    public String insertSungJuk(_01_15_08_SunkJuk_VO sj) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        String result = "성적데이터 처리중...?!?";

        conn = _01_15_08_SungJuk_DBC.makeConn();
        try {
            pstmt = conn.prepareStatement(_01_15_08_SungJuk_DBC.insertSungJuk);
        ...
        _01_15_08_SungJuk_DBC.destoryConn(conn, pstmt);
    ...
    @Override
    public ArrayList<_01_15_08_SunkJuk_VO> selectSungJuk() {
        ArrayList<_01_15_08_SunkJuk_VO> sjs = new ArrayList<>();
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        ...
        conn = _01_15_08_SungJuk_DBC.makeConn();
        try {
            pstmt = conn.prepareStatement(_01_15_08_SungJuk_DBC.selectSungJuk);
            rs = pstmt.executeQuery();
            while(rs.next()){
                _01_15_08_SunkJuk_VO sj = new _01_15_08_SunkJuk_VO(
                        rs.getInt(1),       // sjno
                        rs.getString(2),    // name
                        rs.getInt(3),       // kor
                        rs.getInt(4),       // eng
        ...
        _01_15_08_SungJuk_DBC.destoryConn(conn,pstmt,rs);
    ...
    @Override
    public _01_15_08_SunkJuk_VO selectOneSungJuk(String sjno) {
        _01_15_08_SunkJuk_VO sj = null;
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        ...
        conn = _01_15_08_SungJuk_DBC.makeConn();
        try {
            pstmt = conn.prepareStatement(_01_15_08_SungJuk_DBC.selectOneSungJuk);
            pstmt.setString(1, sjno);
            rs = pstmt.executeQuery();
            if (rs.next()) {
                sj = new _01_15_08_SunkJuk_VO(rs.getInt(1),
                        rs.getString(2),
                        rs.getInt(3),
                        rs.getInt(4),
                        rs.getInt(5),
    ...
    @Override
    public String updateSungJuk(_01_15_08_SunkJuk_VO sj) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ...
        conn = _01_15_08_SungJuk_DBC.makeConn();
        try {
            pstmt = conn.prepareStatement(_01_15_08_SungJuk_DBC.updateSungJuk);
    ...
    public String deleteSungJuk(int sjno) {
        ...
        conn = _01_15_08_SungJuk_DBC.makeConn();
        try {
            pstmt = conn.prepareStatement(_01_15_08_SungJuk_DBC.deleteSungJuk);
            pstmt.setInt(1, sjno);
